...
//                    var yMax = undefined;
    ...
    function afterSetExtremes(e) {
        ...
        if (e.trigger == "navigator" || e.trigger == "zoom") {
            ...
            load_data(chart, now < chart.xAxis[0].max);
        }
    }
    ...
    $.getJSON(navigator_data_url, function (data) {
        ...
        navigator_data.push([xMax + 3600 * 1000, undefined]);
    ...
    //            type: 'arearange',
            ...
            chart.xAxis[0].setExtremes(xMax - 3600 * 1000, xMax + 1800 * 1000);
        }
...
//        return;
        ...
        setInterval(function() {
            ...
            let new_navigator_date = new Date(last_navigator_timestamp + 5 * 1000);
//            let last_navigator_date_str = last_navigator_date.toISOString();

//            navigator_data.push([new_navigator_date, navigator_data[0][1]])
//            chart.navigator.series[0].setData(navigator_data);
